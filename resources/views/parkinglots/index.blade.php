...
<main class="vh-100 d-flex justify-content-center">
    <div class="container px-5 my-5 px-5">
        <div class="card-decks row d-flex justify-content-center">
            @foreach ($parkinglots as $item)
                <div class="card p-4 m-3" style="width: 18rem;">
                    {{-- <img src="..." class="card-img-top" alt="..."> --}}
                    <div class="card-body">
                    <h4 class="card-title">{{ $item->parking_name }}</h4>
                    <br>
                    <p class="card-text">Kapasitas Parkir: {{ $item->capacity }}</p>
                    <p class="card-text">Alamat: {{ $item->address }}</p>
                    <p class="card-text">Biaya: {{ $item->cost }}</p>

                    {{-- Modal Reservasi Parkir --}}
